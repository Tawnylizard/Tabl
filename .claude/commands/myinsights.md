...
- **Error Signatures:** Exact error strings, codes, or exception names that can be grepped
  (e.g., `IllegalStateException`, `WorkManager`, `BOOT_COMPLETED`)
...
- **Tags:** Relevant categories (e.g., `workmanager`, `room`, `notification`, `hilt`, `compose`)
- **Related:** Links to other insights, docs, or issues (e.g., `INS-003`)
