...
3. **Make implementation modular** for reuse in other features
4. Save frequent commits to git
...
| security | Security surface | FLAG_IMMUTABLE, exported flags, input validation |
| performance | Hot paths | Coroutine scope, recomposition, DB queries |
...
4. Re-review critical findings until clean
