...
**PRD Generation:**
```
view(".claude/skills/sparc-prd-mini/templates/prd.md")
...
**Reference:**
```
view(".claude/skills/sparc-prd-mini/references/sparc-methodology.md")
...
**CLAUDE.md:**
```
view(".claude/skills/sparc-prd-mini/templates/CLAUDE.md")
